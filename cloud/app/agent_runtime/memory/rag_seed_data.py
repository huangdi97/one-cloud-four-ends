    ...
    records.extend(
        [
            ...
            (
                ...
                "阿托伐他汀是一种HMG-CoA还原酶抑制剂，用于高胆固醇血症和冠心病防治。"
                "常用剂量为10-40mg每日一次。可降低LDL-C 39-60%。"
                "注意监测肝功能和肌酸激酶，与某些CYP3A4抑制剂合用时需调整剂量。",
    ...
    records.extend(
        [
            (
                ...
                "2024版非小细胞肺癌诊疗指南更新要点：对EGFR突变阳性患者，一线推荐奥希替尼或阿维灵。"
                "新增免疫联合化疗方案用于PD-L1阳性患者。"
                "脑转移患者推荐TKI治疗优先于全脑放疗。"
                "分子检测推荐NGS panel覆盖至少10个驱动基因。",
            ...
            (
                "guideline:copd_2024",
                "GOLD 2024慢阻肺诊疗策略：初始评估强调症状和急性加重风险的个体化评估。"
                "药物治疗推荐LAMA/LABA联合作为初始方案，血嗜酸性粒细胞计数指导ICS使用。"
                "非药物治疗强调肺康复、疫苗接种和自我管理教育。",
